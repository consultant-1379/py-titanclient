...
if TYPE_CHECKING:
    ...
    from ..models.new_report_log_values import NewReportLogValues


T = TypeVar("T", bound="NewReportLog")
...
class NewReportLog:
    ...
    Attributes:
        ...
        values (Union[Unset, NewReportLogValues]):
    """
    ...
    values: Union[Unset, "NewReportLogValues"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_values, Unset):
            ...
            values = NewReportLogValues.from_dict(_values)
        ...
        new_report_log.additional_properties = d
        return new_report_log

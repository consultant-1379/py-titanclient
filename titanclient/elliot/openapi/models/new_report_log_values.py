...
T = TypeVar("T", bound="NewReportLogValues")


@_attrs_define
class NewReportLogValues:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_report_log_values.additional_properties = d
        return new_report_log_values
